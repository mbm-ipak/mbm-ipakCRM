...
$MBM_Ipak_CRM_Hooks = new MBM_Ipak_CRM_Hooks;

add_action($table . "_after_insert", array($MBM_Ipak_CRM_Hooks, "insert"), 10, 4);

add_action($table . "_after_update", array($MBM_Ipak_CRM_Hooks, "update"), 10, 4);

add_action($table . "_after_delete", array($MBM_Ipak_CRM_Hooks, "delete"), 10, 1);
